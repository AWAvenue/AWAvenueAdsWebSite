...
export default defineConfig({
  ...
  copyright: 'Copyright © 2025 <a href="https://t.me/AWAvenue" target="_blank" rel="noopener">秋风のとおり道</a> & <a href="https://awads.cc/" target="_blank" rel="noopener">秋风塬上</a>' // 版权信息
},
    socialLinks: [
      { icon: 'github', link: 'https://github.com/TG-Twilight/AWAvenue-Ads-Rule' } // GitHub 链接
    ]
  }
})
